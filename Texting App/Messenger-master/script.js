...
.controller('cntr_logout', function($scope,$http,$rootScope){
...
.controller('cntr_message', function($scope,$http,$rootScope,$location){
    ...
    $rootScope.msg_div=false;
    $rootScope.sent_div=false;
    $rootScope.area=false;
    ...
    var loggedFname;
     ...
     $scope.deleteClickEvent = function(obj) {
       console.log("deleteClickEvent");
		...
		//console.log("index: "+$rootScope.msgDetails.indexOf(obj));
		 
         for(var i=0;i<tempdetails.length;i++){
             //console.log(tempdetails[i]);
    ...
    $scope.sendClickEvent = function() {
        ...
        var newMsg={
            ...
            "sender":$rootScope.replyMsg.recipient,
            "sender_img":"http://simpleicon.com/wp-content/uploads/user1.png",
            "title":$rootScope.replyMsg.title,
    ...
    $scope.inboxClickEvent = function() {
       ...
       // $rootScope.msgDetails=response.data;
        ...
        console.log("message data is copied "+$scope.msgs);
